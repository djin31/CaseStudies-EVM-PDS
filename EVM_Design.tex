...
\begin{itemize}
\item \textbf{Lack of encryption} - The data is stored over the EVM in plain text format which makes it vulnerable to data leaks. If the attacker gets access to data then he can simply read it off any bits to ASCII converter.
\end{itemize}
